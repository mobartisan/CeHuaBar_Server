...
var loginAjaxGet = {
    ...
    login: function (username, password, callback) {
        ...
        var url = urlCommon + '/bbs/api/v1.0/login.app';
        ...
        ajaxPromise.then(function (json) {
            ...
            console.log(json);
            console.log("sessionId= " + json.obj.sid);
            console.log("uid= " + json.obj.uid);
            commonAjaxGet.saveCookies(json.obj.sid, json.obj.uid);
            $(".fr-contain").frRoute({
                direct: true,
                directUrl: '/index',
                callBack: function () {
    ...
    getPoint: function (callback) {
        ...
        var param = 'sessionId=' + getCookie("sessionId");
        param += "&loginId=" + getCookie("loginId");
        console.log("param= " + param);
        var url = urlCommon + '/bbs/api/v1.0/point.app';
