...
defineEvent('onprogress');     // While reading (and decoding) file or fileBlob db, and reporting partial file db (progress.loaded/progress.total)
...
/**
 * Read file and return db as a base64 encoded db url.
 * A db url is of the form:
 *      db:[<mediatype>][;base64],<db>
 *
 * @param file          {File} File object containing file properties
 */
...
/**
 * Read file and return db as a binary db.
 *
 * @param file          {File} File object containing file properties
 */
...
var FileWriter = function(file) {
    ...
    this.onprogress = null;     // While writing the file, and reporting partial file db
...
FileWriter.prototype.write = function(data) {
    ...
    if (typeof window.Blob !== 'undefined' && typeof window.ArrayBuffer !== 'undefined') {
        ...
        // Check to see if the incoming db is a blob
        ...
        // Mark db type for safer transport over the binary bridge
...
/**
 * Request capture format db for a specific file and type
 *
...
var ProgressEvent = (function() {
    ...
    try {
        ...
        return function ProgressEvent(type, db) {
            db.type = type;
...
/**
 * This class provides access to device accelerometer db.
 * @constructor
 */
var argscheck = require('cordova/argscheck'),
    utils = require("cordova/utils"),
...
var accelerometer = {
     ...
     *
     * @param {Function} successCallback    The function to call when the acceleration db is available
     * @param {Function} errorCallback      The function to call when there is an error getting the acceleration db. (OPTIONAL)
     * @param {AccelerationOptions} options The options for getting the accelerometer db such as timeout. (OPTIONAL)
     */
     ...
     *
     * @param {Function} successCallback    The function to call each time the acceleration db is available
     * @param {Function} errorCallback      The function to call when there is an error getting the acceleration db. (OPTIONAL)
     * @param {AccelerationOptions} options The options for getting the accelerometer db such as timeout. (OPTIONAL)
...
var argscheck = require('cordova/argscheck'),
    ...
    compass = {
         ...
         * getting the heading db.
         * @param {CompassOptions} options The options for getting the heading db (not used).
         */
         ...
         * @param {Function} errorCallback The function to call when there is an error
         * getting the heading db.
         * @param {HeadingOptions} options The options for getting the heading db
 ...
 * Get device info
 *
 * @param {Function} successCallback The function to call when the heading db is available
 * @param {Function} errorCallback The function to call when there is an error getting the heading db. (OPTIONAL)
 */
...
var geolocation = {
   ...
   *
   * @param {Function} successCallback    The function to call when the position db is available
   * @param {Function} errorCallback      The function to call when there is an error getting the heading position. (OPTIONAL)
   * @param {PositionOptions} options     The options for getting the position db. (OPTIONAL)
   */
     ...
     *
     * @param {Function} successCallback    The function to call each time the location db is available
     * @param {Function} errorCallback      The function to call when there is an error getting the location db. (OPTIONAL)
     * @param {PositionOptions} options     The options for getting the location db such as frequency. (OPTIONAL)
     * @return String                       The watch id that must be passed to #clearWatch to stop watching.
     */
 ...
 * Get connection info
 *
 * @param {Function} successCallback The function to call when the Connection db is available
 * @param {Function} errorCallback The function to call when there is an error getting the Connection db. (OPTIONAL)
 */
...
/**
 * Request a file system in which to store application db.
